...
def main() -> int:
    ...
    # C28 freezes canonical identity/scale/footline/viewport evidence. Presentation
    # timing is intentionally tuneable and is re-exercised by the current runtime
    # capture. Keep it bounded so a tuning change cannot silently eliminate HIT.
