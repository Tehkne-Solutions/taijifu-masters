...
func _draw_lian_wu() -> void:
	...
	# Casaco branco e lapelas azuis sobre a silhueta procedural base.
	...
	# Uma única katana. Em repouso permanece embainhada; durante o ataque a
	# lâmina avança na direção do golpe, sem criar uma segunda arma.
	...
	# Marca de água legível mesmo sem sprites finais.
...
func _draw_training_rival() -> void:
	...
	# Tronco mais pesado e placas assimétricas para leitura imediata da IA.
	draw_colored_polygon(
	...
	# Manoplas grandes reforçam o alcance curto e a pressão de postura.
