...
The script creates required directories, expands the closed inventory into
explicit paths and calculates production status only from files that exist.
"""
...
ANIMATIONS = {
    "idle": 6, "walk": 8, "run": 8, "jump_start": 4, "jump_loop": 3,
    "fall": 3, "land": 4, "attack_light_01": 6, "attack_light_02": 7,
    "attack_heavy": 9, "dash": 5, "block": 4, "parry": 5,
    "skill_water_dragon": 10, "hurt": 4, "knockback": 5,
    "downed": 6, "death": 8, "victory": 8,
}
